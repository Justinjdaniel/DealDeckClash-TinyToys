...
export const Menu: React.FC<MenuProps> = ({ onStartGame }) => {
  ...
  const botStyles: { name: BotStyle; desc: string; icon: LucideIcon }[] = [
    {
      name: "Aggressive",
      desc: "Focuses on disrupting completed sets and charging massive rent.",
      icon: Terminal,
    },
    {
      name: "Defensive",
      desc: "Prioritizes safety, banking cash, and holding counters.",
      icon: Shield,
    },
    {
      name: "Hoarder",
      desc: "Hoards property cards and builds massive private vaults.",
      icon: Disc,
    },
  ];
    ...
    <div className="min-h-screen bg-radial-gradient-felt flex flex-col items-center justify-center p-4">
      ...
      <div className="max-w-4xl w-full glass-panel rounded-3xl p-8 md:p-12 shadow-2xl relative border-2 border-casino-gold/30">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-white font-serif">
                  Singleplayer Boardroom
                </h2>
              </div>
              <p className="text-gray-300 text-sm mb-6">
                Challenge our tactical client-side heuristic AI bot configured
                with unique playing styles and strategic decision-making trees.
              </p>
              ...
              <div className="space-y-3 mb-6">
                {botStyles.map((style) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`p-2 rounded-lg ${isSelected ? "bg-casino-gold text-casino-felt" : "bg-white/5 text-casino-gold"}`}
                      >
            ...
            {!isMultiplayer ? (
              <div className="flex flex-col justify-between h-full">
                <div>
                  ...
                  <p className="text-gray-300 text-sm mb-6">
                    Future-proof network interface fully compatible with
                    asynchronous API calls and WebSocket room subscriptions.
                  </p>
                  ...
                  <div className="rounded-xl border border-dashed border-casino-gold/20 p-5 bg-black/10 text-center text-gray-400 mb-6">
                    ...
                    <span className="text-xs font-semibold text-casino-gold/90 block mb-1">
                      NETWORK DECOUPLING ACTIVE
                    </span>
                    <span className="text-[11px] leading-relaxed">
                      All game states are fully abstracted. Activating
                      multiplayer loads a simulated network API layer.
                    </span>
                  </div>
                </div>
                ...
                {multiplayerMode === "room" && (
                  <div className="space-y-4">
                    <div className="border-b border-white/10 pb-3 text-center">
                      <div className="text-[10px] uppercase text-casino-gold tracking-widest font-bold">
                        Room Active
                      </div>
                    ...
                    <div className="rounded-xl bg-casino-gold/5 p-4 border border-casino-gold/10 text-center">
                      <span className="text-[11px] text-casino-gold/90 font-medium">
                        Mock network abstraction layer online. You can choose to
                        inject a smart AI bot to play as Player 2 inside this
                        decoupled network room.
                      </span>
                    </div>
        ...
        <div className="mt-8 text-center border-t border-white/5 pt-6 text-[11px] text-gray-400">
          Handcrafted modern boardroom. Rules are 100% compliant with the
          official Monopoly Deal handbook.
        </div>
      </div>
    </div>
  );
